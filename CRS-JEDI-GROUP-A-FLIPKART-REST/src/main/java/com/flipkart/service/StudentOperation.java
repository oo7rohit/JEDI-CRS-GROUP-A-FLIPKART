...
public class StudentOperation implements StudentInterface {
	 ...
	 */
	@Override
	public String register(String name,String userId,String password,GenderConstant gender,String department,int batch, String address) throws StudentNotRegisteredException{
		String studentId;
		try
		{
			//call the DAO class, and add the student record to the DB
			System.out.println("2 reg");
			Student newStudent=new Student(userId,name,RoleConstant.STUDENT,password,gender,address,department,userId,batch,false);
