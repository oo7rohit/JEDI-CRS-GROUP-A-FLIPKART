...
//			studentInterface.register(student.getName(), student.getUserId(), student.getPassword(), student.getGender(),  student.getDepartment(), student.getAddress());
			studentInterface.register(student.getName(), student.getUserId(), student.getPassword(), student.getGender(),  student.getDepartment(), student.getGradYear(), student.getAddress());
		}
		catch(Exception ex)
		{
//			System.out.println(ex);
			return Response.status(500).entity("Please try again later.").build();
		}
